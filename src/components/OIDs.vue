  ...
  <div class="grid">
    <div class="col-12">
      <div class="card">
        ...
        <DataTable ref="dt" :value="oidList" v-model:selection="selectedAbbs" dataKey="_id" :paginator="true" :rows="10" :filters="filters"
        ...
        <Dialog v-model:visible="deleteAbbDialog" :style="{width: '450px'}" header="Confirm" :modal="true" >
          <div class="flex align-items-center justify-content-center">
            ...
            <span v-if="oidList">Are you sure you want to delete <b>{{oidList.abb}}</b>?</span>
          </div>
          <template #footer>
