<template>
	<div :class="containerClass" @click="onWrapperClick">
        <AppTopBar @menu-toggle="onMenuToggle" @menu-events="topbarevents" @menu-settings="settings" @menu-profiles="profiles" />
          ...
          menu : [
                {
                    ...
                    items: [
                      ...
                      {label: 'Lab inventory', icon: 'pi pi-fw pi-home', to: '/inventory'},
                      {label: 'Lab IP address Management', icon: 'pi pi-fw pi-home', to: '/ipaddr'},
                      {label: 'Automation', icon: 'pi pi-fw pi-home', to: '/automation'}
